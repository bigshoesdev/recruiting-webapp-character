import type { Attributes, Class } from "./../types/types";
...
export const GITHUB_USERNAME = 'bigshoesdev';

export const API_URL = `https://recruiting.verylongdomaintotestwith.ca/api/{{` + GITHUB_USERNAME +`}}/character`;